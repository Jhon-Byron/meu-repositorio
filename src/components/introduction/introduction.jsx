      ...
      <div className="bg-gif-technology">
        <div className="flex items-center flex-col justify-center w-full h-[1050px] ">
          <h1 className="font-One text-[100px] text-center font-medium">
            <span className="text-gray-50 border-b-2 max-md:text-4xl ">OLA, EU SOU O JHON</span>
          </h1>
          <p className="text-xl font-bold tracking-wide max-w-screen-sm text-center border p-2 mt-10 bg-white text-black rounded-xl max-md:rounded-none max-md:text-sm">
